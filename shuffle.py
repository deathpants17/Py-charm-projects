...
def game():
    ...
    def resume():
        win.destroy()
        game()
    words = ["coding", "stop", "start", "icecream", "python", "google", "yahoo", "instagram", "facebook", "add", "car", "project","woman", "user", "race", "balloon", "apple", "banana", "pink", "black", "audi", "truck", "random","window", "help", "orange"]
